...
// Global state
//
static const uint256 hashGenesisBlockOfficial("0x00000b1fc7fe6eaaee787d3577a3a12ca7367f8bc9d91e0673ce345b5bd233d8");
static const uint256 hashGenesisBlockTestNet ("0x00000d0b0df973bb5437cc54ad7943feea29c69b47bd0b7bf6df5f067ad65eeb");
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "March 27 2018 Osiris is Born";
        unsigned int nTimeGenesis=1522201392;
        unsigned int nNonceGenesis=228949;

        if (fTestNet)
        {
            pszTimestamp="Time For Dinner";
            nTimeGenesis=1522201012;
            nNonceGenesis=116262;
        }
        ...
        printf("%s\n", block.hashMerkleRoot.ToString().c_str());
        if (!fTestNet)
            assert(block.hashMerkleRoot == uint256("0x5f46c90e6039d93fafe90cbf35d2b6106ee6d034915ed9c7fec6b11b8e699054"));
        else
            assert(block.hashMerkleRoot == uint256("0x782806012148567b44b0a43c5c1a34b1380e9c9eed82ab0fbfca663aa9176ad9"));
